...
const createSchema = z.object({
  ...
  name: z.string().min(1),
  role: z.enum(['ADMIN', 'PRODUCTION_EMPLOYEE', 'PRODUCTION_MANAGER', 'QC_USER', 'HARNESS_PRODUCTION', 'PACKING', 'SALES', 'ACCOUNTS', 'SHIPPING', 'PURCHASE_MANAGER', 'INVENTORY_MANAGER']),
});

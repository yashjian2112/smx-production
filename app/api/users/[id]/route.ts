...
const updateSchema = z.object({
  ...
  role: z.enum(['ADMIN', 'PRODUCTION_EMPLOYEE', 'PRODUCTION_MANAGER', 'QC_USER', 'HARNESS_PRODUCTION', 'PACKING', 'SALES', 'ACCOUNTS', 'SHIPPING', 'PURCHASE_MANAGER', 'INVENTORY_MANAGER']).optional(),

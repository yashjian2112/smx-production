...
import { Building2, Package, ClipboardList, BarChart3, Settings, User, CheckSquare, Factory, Landmark, TrendingUp, FlaskConical, Cable } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Link href="/admin/harness-connectors" className="block p-6 rounded-xl bg-smx-surface border border-slate-600 hover:border-sky-500 text-center">
          <div className="text-3xl mb-2 flex justify-center"><Cable className="w-5 h-5" /></div>
          <p className="font-medium">Harness Connectors</p>
          <p className="text-slate-400 text-xs mt-1">Configure connectors per harness product for QC</p>
        </Link>

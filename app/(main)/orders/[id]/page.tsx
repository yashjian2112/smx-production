            ...
            {jobCards.map((jc) => {
              ...
              return (
                <div key={jc.id}
                  ...
                  style={{ background: statusColor[jc.status] ?? 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full"
                      style={{ background: 'rgba(255,255,255,0.06)', color: statusText[jc.status] ?? '#9ca3af' }}>
                      {jc.status}
                    </span>

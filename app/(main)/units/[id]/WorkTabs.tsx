...
export function WorkTabs({ unitId, unitSerial, stageBarcode, currentStage, currentStatus, isEmployee, orderId, productName, orderNumber, qcBarcode, powerstageBarcode, brainboardBarcode }: Props) {
